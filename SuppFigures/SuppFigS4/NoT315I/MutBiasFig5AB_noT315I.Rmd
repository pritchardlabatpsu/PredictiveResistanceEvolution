...
imat.df = imat.df[imat.df$Compound!="T315I",]
...
maxitinib.df = read.csv("MaxitinibParametersNoT315I_111919.csv")
...
ggplot(summary.df,aes(x=K))+theme_bw()+
  ...
  scale_x_continuous(breaks=c(1,8,14),labels=c("K1","K8","K14"))+
...
# ggsave("MutBiasFig5E_noT315I.png",width=8,height=6)
