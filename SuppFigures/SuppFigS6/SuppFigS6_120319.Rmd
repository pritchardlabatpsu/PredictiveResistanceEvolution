...
setwd("C:/Users/Scott/Box Sync/MutBias/Reresubmit/ResponseToReviewers/StoltzfusSims/")
```
...
sim.pars = read.csv("ATParameters113019.csv",header=F)
colnames(sim.pars) = c("rho","alpha")

pyr.subs = read.csv("PyrSubs113019.csv",header=F,stringsAsFactors=F)
pyr.subs = paste(pyr.subs$V1,pyr.subs$V2,sep="")
n = length(pyr.subs)

pyr.vec = c("CA","CG","CT","TA","TC","TG")
...
## Transition/Transversion - With Bias
...
ggplot()+theme_bw()+
  ...
  ggtitle(paste("Transition/Transversion Null Model:\n",gene,sep=""))+
...
## Transition/Transversion - Without Bias
...
## 6 Pyrmidine Substitution - With Bias
