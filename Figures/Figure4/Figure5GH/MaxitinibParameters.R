...
setwd("C:/Users/Scott/Box Sync/MutBias/Reresubmit/Figures/Figure5/Figure5AB/NoT315I/")
...
out.noT315I = out.df[out.df$variant!="T315I",]

write.csv(out.noT315I,"MaxitinibParametersNoT315I_111919.csv")
