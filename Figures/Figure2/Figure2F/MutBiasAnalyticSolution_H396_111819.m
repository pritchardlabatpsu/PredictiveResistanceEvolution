...
% 
function log2ratio = MutBiasAnalyticSolution_H396_111819(mu,M)
...
% Allele A: more resistant parameters
% Allele B: more likely parameters
...
prob_H396P = .0107;      % Broad ExAC numbers
prob_H396R = .0383;
...
rho_A = prob_H396P/sum([prob_H396P prob_H396R]);
rho_B = prob_H396R/sum([prob_H396P prob_H396R]);
